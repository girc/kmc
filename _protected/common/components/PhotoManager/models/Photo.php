...
namespace common\components\PhotoManager\models;
...
class Photo extends \yii\db\ActiveRecord
{
    ...
    public function init()
    {
        ...
        $this->uploadPath = Yii::$app->params['uploadPath'] = Yii::getAlias('@uploadPath/');
        $this->uploadUrl = Yii::$app->params['uploadUrl'] = Yii::getAlias('@uploadUrl/');

        Event::on(Building::className(), ActiveRecord::EVENT_AFTER_INSERT, function ($event) {
