 ...
 */
class TempUploadedFile extends ActiveRecord
{
    ...
    public static function getDirectory(){
        $targetPath=Yii::getAlias('@uploads').'/images/temp';
        $path = realpath($targetPath);
        if (!$path) {
            mkdir($targetPath, 0777, true);
        }
        return $targetPath;//Yii::getAlias('@uploads').'/images/temp';
    }

    public function getFilePath($tempName=null,$extension=null){
        return $this::getDirectory().DIRECTORY_SEPARATOR.$this->temp_name.'.'.$this->extension;
    }
